...
A Qt Widgets desktop application for configuring and updating AM32 electronic speed controllers (ESCs) without using the web configurator. The current app identifies itself as Config Tool 1.97.2 and targets AM32 firmware 2.21 and newer.
